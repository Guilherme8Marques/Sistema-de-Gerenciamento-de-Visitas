...
echo ============================================
echo   Instalador do Servico - Ferramenta Visitas
echo ============================================
echo.
...
"%NSSM_EXE%" set %SERVICE_NAME% AppParameters "--import tsx server/index.ts"
"%NSSM_EXE%" set %SERVICE_NAME% AppDirectory "%APP_DIR%"
"%NSSM_EXE%" set %SERVICE_NAME% DisplayName "Ferramenta de Visitas - API Backend"
"%NSSM_EXE%" set %SERVICE_NAME% Description "Servidor Node.js do sistema de Ferramenta de Visitas"
...
echo.
echo O servidor estara rodando de forma invisivel e segura na porta 5000.
echo.
echo Para verificar qualquer erro de importacao, veja os logs em:
echo   %LOGS_DIR%
echo.
pause
