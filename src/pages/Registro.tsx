    ...
    <div className="flex-1 flex flex-col">
      ...
      <header className="relative z-10 flex items-center gap-3 px-5 pt-6 pb-4">
        ...
        <div className="flex items-center gap-4">
          <img src={iconRegistro} alt="Icone Registro" className="w-20 h-20 object-contain drop-shadow-2xl" />
          <h1 className="text-2xl font-display font-bold text-primary-foreground">Registro de Visitas</h1>
        </div>
      </header>
